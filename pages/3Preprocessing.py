...
if 'df' not in st.session_state:
    try:
        ...
        df = df[(df['Umur'] > 17) & (df['Umur'] <= 23)]  # Filter data for age between 18 and 23
...
original_df = original_df[(original_df['Umur'] > 17) & (original_df['Umur'] <= 23)]  # Filter data for age between 18 and 23
